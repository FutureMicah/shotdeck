  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground">
      <div className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute -top-40 -left-32 h-96 w-96 rounded-full bg-primary/25 blur-[120px]" />
        <div className="absolute top-1/3 -right-32 h-96 w-96 rounded-full bg-accent/20 blur-[130px]" />
        <div className="absolute bottom-0 left-1/4 h-80 w-80 rounded-full bg-chart-4/10 blur-[130px]" />
      </div>
